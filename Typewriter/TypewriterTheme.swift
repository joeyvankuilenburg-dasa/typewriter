...
enum TypewriterTheme {
    // MARK: - Colors
    static let background = NSColor(srgbRed: 0.969, green: 0.969, blue: 0.969, alpha: 1) // #F7F7F7
    ...
    // MARK: - Fonts
    static let bodyFont = NSFont.monospacedSystemFont(ofSize: 20, weight: .regular)
